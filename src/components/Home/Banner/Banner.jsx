        ...
        <Parallax blur={{ min: -15, max: 15 }} bgImage="https://i.ibb.co/b5qLBHj/bg.jpg" strength={100}>
            <div className="hero h-[1200px]">
                <div className="hero-content text-center text-neutral-content">
                    <div className='hero-overlay rounded-xl bg-opacity-30 w-[1400px] h-[700px]'>
                        <div className='mt-32 text-left flex ml-20'>
                            <div>
                                <h1 className="mb-5 text-5xl font-bold">Hello <br /> Myself Bijori</h1>
                                <p className="mb-5 text-3xl font-semibold">A Junior React Developer</p>
