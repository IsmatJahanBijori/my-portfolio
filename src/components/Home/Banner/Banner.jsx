                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className='hero-overlay rounded-xl bg-opacity-30 w-[500px] md:w-[1600px] h-[1000px] lg:h-[700px]'>
                        <div className='mt-16 md:mt-32 text-left flex flex-col lg:flex-row md:ml-20'>
                            <div className='ml-5'>
                                <h1 className="mb-5 text-5xl font-bold md:text-center">Hello <br/> Myself <span className='text-[#64CCC5]'>Bijori</span></h1>
                                <p className="mb-5 text-3xl md:text-center font-semibold">A Junior <br />  <span className='text-[#64CCC5]'>React Developer</span></p>
